/*****************************************************************************
* Filename:          C:\hlocal\Practica3segundointento/drivers/my_periferico_v1_00_a/src/my_periferico_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the my_periferico driver
...
XStatus MY_PERIFERICO_SelfTest(void * baseaddr_p)
{
  ...
  MY_PERIFERICO_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MY_PERIFERICO_mReadSlaveReg0(baseaddr, 0);
  ...
  MY_PERIFERICO_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MY_PERIFERICO_mReadSlaveReg1(baseaddr, 0);
  ...
  MY_PERIFERICO_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MY_PERIFERICO_mReadSlaveReg2(baseaddr, 0);
  ...
  MY_PERIFERICO_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MY_PERIFERICO_mReadSlaveReg3(baseaddr, 0);
