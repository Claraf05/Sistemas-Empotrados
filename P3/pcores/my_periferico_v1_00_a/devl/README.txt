...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\hlocal\Practica3segundointento
  logical library name                       : my_periferico_v1_00_a
  top name                                   : my_periferico
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- ISE project file(s)
  ...
  devl/projnav/my_periferico.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/my_periferico_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/my_periferico_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/my_periferico_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	C:\hlocal\Practica3segundointento\C:\Xilinx\14.1\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
